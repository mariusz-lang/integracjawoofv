...
printf( __( "W załączniku przesyłamy rachunek do zamówienia %s.", 'woocommerce-fakturownia' ) , $order->get_order_number() ) . "\n\n";
if ( isset( $download_url ) ) {
	printf( __( 'Rachunek do zamówienia: %s', 'woocommerce-fakturownia' ), $download_url ) . "\n\n";
}
