<?php
/**
 * Email z fakturą korygującą(plain text)
 */
/**
 * @var $order WC_Order
 */
...
printf( esc_html__( "W załączniku przesyłamy fakturę korygującą do zamówienia %s.", 'woocommerce-fakturownia' ) , $order->get_order_number() ) . "\n\n";

if ( isset( $download_url ) ) {
	printf( esc_html__( 'Faktura korygująca do zamówienia: %s', 'woocommerce-fakturownia' ), $download_url ) . "\n\n";
}
...
if ( $order->get_billing_email() )
	esc_html_e( 'Email:', 'woocommerce' ); echo $order->get_billing_email() . "\n";

if ( $order->get_billing_phone() )
	esc_html_e( 'Tel:', 'woocommerce' ); ?> <?php echo $order->get_billing_phone() . "\n";
