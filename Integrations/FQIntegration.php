...
namespace WPDesk\WooCommerceFakturownia\Integrations;

use WC_Order_Item;
use WPDesk\WooCommerceFakturownia\Helpers\Plugin;
...
class FQIntegration {
	...
	public function get_item_unit( $default = 'szt' ): string {
		...
		if ( $fq_quantity === $this->order_item->get_quantity() && $measurement_unit ) {
			return __( $measurement_unit, $this->domain ); //phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText,WordPress.WP.I18n.NonSingularStringLiteralDomain
		}
